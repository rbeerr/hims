        ...
        <div class="flex justify-between h-16 ">
            <div class="flex">
                ...
                <div class="flex items-center shrink-0">
                    <img src="{{ asset('assets/logo.png') }}" alt="Your Logo's Alt Text" class="block w-auto h-12">
                </div>
                ...
                <!-- Manage Account -->
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link class="text-xl text-white" href="{{ route('manage-account') }}" :active="request()->routeIs('manage-account')">
                        {{ __('Manage Account') }} @livewire('user-badge')
                    </x-jet-nav-link>
                </div>
            </div>
